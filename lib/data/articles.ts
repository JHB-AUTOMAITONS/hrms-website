...
export const articles: ArticleMeta[] = [
  ...
  {
    slug: "best-leave-management-software-india",
    title: "Best Leave Management Software in India (2026)",
    excerpt: "What leave management software needs to handle for Indian leave policies, and how to evaluate one before you commit.",
    category: "Leave",
    publishedDate: "2026-09-01",
    readTime: "6 min read",
  },
  {
    slug: "recruitment-crm-vs-ats",
    title: "Recruitment CRM vs ATS: What's the Difference?",
    excerpt: "An ATS and a recruitment CRM solve different problems — what each does, and which one an HRMS hiring module actually is.",
    category: "Recruitment",
    publishedDate: "2026-09-01",
    readTime: "5 min read",
  },
  {
    slug: "free-vs-paid-staff-management-software",
    title: "Free vs Paid Staff Management Software: What You Actually Get",
    excerpt: "Free tools aren't free once you count HR's time. Where they hold up, and where they quietly cost more than a paid platform.",
    category: "HR",
    publishedDate: "2026-09-01",
    readTime: "6 min read",
  },
