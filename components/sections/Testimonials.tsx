      ...
      <Container>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <figure key={testimonial.authorName} className="rounded-2xl border border-ink-900/8 bg-white p-6">
              <blockquote className="text-pretty text-sm text-slate-700">&ldquo;{testimonial.quote}&rdquo;</blockquote>
